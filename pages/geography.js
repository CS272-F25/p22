...
// Set this page’s category (Geography)
const currentCategory = CATEGORY.GEOGRAPHY;
...
function checkIfQuizComplete() {
    ...
    saveQuizResultsToLocalStorage("Geography", currentDifficulty, score, timeFormatted);
...
document.getElementById("save-btn").addEventListener("click", () => {
    ...
    // Build entry
    const entry = {
        subject: "Geography",               // CHANGE THIS per subject file
